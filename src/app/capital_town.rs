...
fn dressing(kx: i32, ky: i32) -> &'static [Dress] {
    match (kx, ky) {
        ...
        (3, 4) => &[
            (&CP_ROSE, 174.0, 24.0, false, None),
            (&CP_CATHDOOR, 172.0, 52.0, false, None),
            (&CP_CROSSTOP, 180.0, 2.0, false, None),
            (&CP_WINDOW, 128.0, 28.0, false, None),
            (&CP_WINDOW, 228.0, 28.0, false, None),
