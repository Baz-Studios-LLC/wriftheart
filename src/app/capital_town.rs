...
fn dressing(kx: i32, ky: i32) -> &'static [Dress] {
    match (kx, ky) {
        ...
        (0, 0) => &[
            ...
            (&CP_BENCH, 74.0, 102.0, false, Some((75.0, 106.0, 18.0, 4.0))),
            (&CP_BENCH, 242.0, 116.0, false, Some((243.0, 120.0, 18.0, 4.0))),
            (&CP_URN, 162.0, 32.0, false, Some((164.0, 40.0, 8.0, 5.0))),
            (&CP_URN, 120.0, 190.0, false, Some((122.0, 198.0, 8.0, 5.0))),
            (&CP_URN, 204.0, 190.0, false, Some((206.0, 198.0, 8.0, 5.0))),
        ...
        (4, 0) => &[
            ...
            (&CP_BENCH, 42.0, 116.0, false, Some((43.0, 120.0, 18.0, 4.0))),
            (&CP_BENCH, 210.0, 102.0, false, Some((211.0, 106.0, 18.0, 4.0))),
            (&CP_URN, 130.0, 32.0, false, Some((132.0, 40.0, 8.0, 5.0))),
            (&CP_URN, 88.0, 190.0, false, Some((90.0, 198.0, 8.0, 5.0))),
            (&CP_URN, 172.0, 190.0, false, Some((174.0, 198.0, 8.0, 5.0))),
