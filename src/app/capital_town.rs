...
pub struct CapitalInn {
    /// Which interior the door opens ("crowninn", "church", ...).
    pub kind: &'static str,
    pub x: f32,
    pub y: f32,
}
...
const CP_CATHEDRAL: [&str; 80] = [
    ".............yy.......................................................KyyK.......................................................yy.............",
    "............KyyK....................................................yyyyyyyy....................................................KyyK............",
    "...........KbbbbK...................................................yyyyyyyy...................................................KbbbbK...........",
    "..........KbbbbbbK....................................................yyyy....................................................KbbbbbbK..........",
    ".........KbbbbbbbbK.................................................KAyyyyAK.................................................KbbbbbbbbK.........",
    "........KbbbbbbbbbbK............................................KAAAAAyyyyAAAAAK............................................KbbbbbbbbbbK........",
    ".......KbbbbbbbbbbbbK.......................................KAAAAAAAAAAAAAAAAAAAAAAK.......................................KbbbbbbbbbbbbK.......",
    "......KbbbbbbbbbbbbbbK..................................KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK..................................KbbbbbbbbbbbbbbK......",
    ".....KbbbbbbbbbbbbbbbbK.............................KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK.............................KbbbbbbbbbbbbbbbbK.....",
    "....KbbbbbbbbbbbbbbbbbbK........................KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK........................KbbbbbbbbbbbbbbbbbbK....",
    "...KbbbbbbbbbbbbbbbbbbbbK...................KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK...................KbbbbbbbbbbbbbbbbbbbbK...",
    "..KbbbbbbbbbbbbbbbbbbbbbbK..............KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK..............KbbbbbbbbbbbbbbbbbbbbbbK..",
    ".KbbbbbbbbbbbbbbbbbbbbbbbbK.........KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK.........KbbbbbbbbbbbbbbbbbbbbbbbbK.",
    "KbbbbbbbbbbbbbbbbbbbbbbbbbbK....KAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK....KbbbbbbbbbbbbbbbbbbbbbbbbbbK",
    "KKKKKKKKKKKKKKKKKKKKKKKKKKKaaaaaaAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAaaaaaaKKKKKKKKKKKKKKKKKKKKKKKKKKK",
    "aaAAAAAAAAAAAAAAAAAAAAAAKAAaaaaaaAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAaaaaaaAAKAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAsaaaaaaKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKaaaaaasAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKKKKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKbbyybbKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAKKKKKKKKKKKKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbyybbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKKKKKKKKKKKKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbyybbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbyybbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbbyybbbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbbbbyybbbbbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbyyyyyybbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbbyyyyyyyybbbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbyybbyybbyybbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbyybbyybbyybbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKooooKKooooKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbyybbbyybbbyybbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKooooKKooooKAAAAAAaa",
    "aaAAAAAAKKKKKKKKKKKKAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAKKyyyyyyyyyyyyyyyyyyyyyyyyKKAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAKKKKKKKKKKKKAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbyybbbyybbbyybbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbyybbyybbyybbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbyybbyybbyybbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbbyyyyyyyybbbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbyyyyyybbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKbbbbbbbbbyybbbbbbbbbKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbbyybbbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbyybbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbbbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAKKKKKKKKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKbbbbbbbbbbbbKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKKKKKKKKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKbbbbbbKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKKKKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKKKKKKKKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaasAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAssssssssssssssssssssAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKKKKKKKKAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAAAAAAAAAssssssssssssssssssssssssAAAAAAAAAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAKKKKKKKKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKKKKKKKKAAAAAAAAAAAAAAssssssssssssssssssssssssssssAAAAAAAAAAAAAAKKKKKKKKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAAAAAsssssssssaaaaaaaaaaaaaasssssssssAAAAAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAAAsssssssssaaaaaaaaaaaaaaaaaasssssssssAAAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssssssssaaaaaaaaaaaaaaaaaaaaaasssssssssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssssssaaaaaaaaaAAAAAAAAaaaaaaaaasssssssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssssaaaaaaaaaAAAAAAAAAAAAaaaaaaaaasssssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaaaaaaaAAAAAAAAAAAAAAAAaaaaaaaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKooKKooKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaaaaaAAAAAAAAAAAAAAAAAAAAaaaaaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKooKKooKAAAAAAAAaa",
    "aaAAAAAAAAKKKKKKKKAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaaabbbbbbbbbbyyyybbbbbbbbbbaaaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAKKKKKKKKAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAbbbbbbbbbbyyyybbbbbbbbbbAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKKKKKKKKAAAAAAAAsssaaaAAbbbbbbbbbbbbbbbbbbbbbbbbAAaaasssAAAAAAAAKKKKKKKKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAAAAAAAAAAAAAAAAAAAAAAAAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKKKKKKKKKKKKKKKKKKKKKKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAaaaaaaaaaaaaaaaaaaaaAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAaaaaaaaaaaaaaaaaaaaaAAaa",
    "aaAAaaaaaaaaaaaaaaaaaaaaAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAaaaaaaaaaaaaaaaaaaaaAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKooKKooKAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAKooKKooKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAKKKKKKKKAAAAAAAAsssaaaAAAKDDDDDyDDDKKDDDyDDDDDKAAAaaasssAAAAAAAAKKKKKKKKAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    "aaAAAAAAAAAAAAAAAAAAAAAAAAssAAAsAAAAAAAAAAAAAAAAAAAAsssaaaAAAKDDDDDDDDDKKDDDDDDDDDKAAAaaasssAAAAAAAAAAAAAAAAAAAAsAAAssAAAAAAAAAAAAAAAAAAAAAAAAaa",
    ...
    *woke = Some((cur.rx, cur.ry));
    ...
    if (kx, ky) == (3, 1) {
        ...
        commands.spawn((
            ...
            CapitalInn { kind: "crowninn", x: 146.0, y: 94.0 },
            CapFx { frames, t: 0 },
        ));
    }
    // THE CATHEDRAL (3,4): a bespoke gothic west front (Baz: not tiles) —
    // twin spires, the rose, a recessed portal whose doors open the church.
    if (kx, ky) == (3, 4) {
        let img = images.add(crate::gfx::bake(&CP_CATHEDRAL, CAPITAL_PAL));
        let blk = (114.0, 20.0, 140.0, 56.0);
        if !blockers.0.contains(&blk) {
            blockers.0.push(blk);
        }
        commands.spawn((
            Sprite::from_image(img),
            at(PLAY_X + 112.0, PLAY_Y + 0.0, 144.0, 80.0, actor_z(78.0)),
            PIXEL_LAYER,
            RoomActor,
            CapitalProp,
            super::shadows::CastsShadow { left: 116.0, top: 76.0, w: 136, a: 0.9 },
            CapitalInn { kind: "church", x: 182.0, y: 84.0 },
        ));
    }
