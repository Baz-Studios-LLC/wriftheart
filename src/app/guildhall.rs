...
const GH_RUG2: [&str; 36] = [
    "GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG",
    "GFGFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFGFG",
    "GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG",
    "GFGFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFGFG",
    "GFGFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFGFG",
    "GFGFFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFGFG",
    "GFGFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfFFFFFFGFG",
    "GFGFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfGFFFFFFfFFFFFFFfFFFFFFFfFFFFFFFGFG",
    "GFGFFFFFfFFFFFFFfFFFFFFFfFFFFFFFfGGGFFFFfFFFFFFFfFFFFFFFfFFFFFFFFGFG",
    "GFGFFFFfFFFFFFFfFFFFFFFfFFFFFFFfGGFGGFFfFFFFFFFfFFFFFFFfFFFFFFFFFGFG",
    "GFGFFFfFFFFFFFfFFFFFFFfFFFFFFFfGGFFFGGfFFFFFFFfFFFFFFFfFFFFFFFfFFGFG",
    "GFGFFfFFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFGGFFFFFFfFFFFFFFfFFFFFFFfFFFGFG",
    "GFGFFFFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFGGFFFFfFFFFFFFfFFFFFFFfFFFFGFG",
    "GFGFFFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFFFGGFFfFFFFFFFfFFFFFFFfFFFFFGFG",
    "GFGFFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFFFFFGGfFFFFFFFfFFFFFFFfFFFFFFGFG",
    "GFGFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFFFFFFFGGFFFFFFfFFFFFFFfFFFFFFFGFG",
    "GFGFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFGFFFFFfFGGFFFFfFFFFFFFfFFFFFFFFGFG",
    "GFGFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFGGGFFFfFFFGGFFfFFFFFFFfFFFFFFFFFGFG",
    "GFGFFFfFFFFFFFfFFFFFFFfGGFFFFFfFGGGGGFfFFFFFGGfFFFFFFFfFFFFFFFfFFGFG",
    "GFGFFfFFFFFFFfFFFFFFFfFFGGFFFfFFFGGGFfFFFFFGGfFFFFFFFfFFFFFFFfFFFGFG",
    "GFGFFFFFFFFFfFFFFFFFfFFFFGGFfFFFFFGFfFFFFFGGfFFFFFFFfFFFFFFFfFFFFGFG",
    "GFGFFFFFFFFfFFFFFFFfFFFFFFGGFFFFFFFfFFFFFGGfFFFFFFFfFFFFFFFfFFFFFGFG",
    "GFGFFFFFFFfFFFFFFFfFFFFFFFfGGFFFFFfFFFFFGGfFFFFFFFfFFFFFFFfFFFFFFGFG",
...
fn altar_wake(
    ...
    *woke = Some(key);
    ...
    if run.drx == 0 && (run.dry == 0 || run.dry == -1) {
        let south = run.dry == 0;
        // The gallery hangs in the NORTH chamber only — the south room's top edge
        // is the wide open seam between the two rooms (shields floated on air).
        for (i, w) in WINGS.iter().enumerate().filter(|_| !south) {
            ...
            commands.spawn((
                Sprite::from_image(img),
                at(PLAY_X + 88.0 + i as f32 * 28.0, PLAY_Y + 18.0, 12.0, 13.0, 3.3),
                PIXEL_LAYER,
                RoomActor,
                HallCast,
            ));
        ...
        if south {
            // The working lobby: the steward's desk, the aisle rug, the pillars.
            ...
            // The council chamber, COMPOSED (Baz: organize it; a hearth is a WALL
            // fixture): banquet rug centered, the table on it, candelabras flanking,
            // the hearth recessed into the top wall like the torches.
            fixed.push((&GH_RUG2, GH_RUG_PAL, 118.0, 78.0, 2.4, None));
            fixed.push((&GH_COUNCIL, GH_COUNCIL_PAL, 130.0, 88.0, 0.0, Some((131.0, 92.0, 42.0, 5.0))));
            fixed.push((&GH_CANDEL, GH_CANDEL_PAL, 106.0, 84.0, 0.0, Some((108.0, 92.0, 6.0, 4.0))));
            fixed.push((&GH_CANDEL, GH_CANDEL_PAL, 190.0, 84.0, 0.0, Some((192.0, 92.0, 6.0, 4.0))));
            fixed.push((&GH_HEARTH, GH_HEARTH_PAL, 234.0, 20.0, 3.3, None));
        }
